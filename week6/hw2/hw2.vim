...
silent only
silent tabonly
cd ~/Desktop/LIDEMY/mentor-program-4th-JAS0NHUANG/homeworks/week6/hw2
...
exe 'vert 1resize ' . ((&columns * 93 + 64) / 128)
exe '2resize ' . ((&lines * 7 + 20) / 40)
exe 'vert 2resize ' . ((&columns * 93 + 64) / 128)
exe 'vert 3resize ' . ((&columns * 34 + 64) / 128)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 62 - ((25 * winheight(0) + 15) / 30)
...
wincmd w
argglobal
terminal ++curwin ++cols=93 ++rows=10 
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 116 - ((18 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
116
